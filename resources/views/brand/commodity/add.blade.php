        ...
        <div class="commodity-msg-edit">
                ...
                <div class="edit-commodity">
                    ...
                    <div class="commodity-class-list div_place">
                      <span>一级产区：</span>
                      <input type="text" placeholder="国家" class="class-commodity" name="produce_area1" id="produce_area1" />
                      <span>二级产区：</span>                  
                      <input type="text" placeholder="国家地区" class="class-commodity" name="produce_area2" id="produce_area2" />
                    </div>
                ...
                <div class="edit-commodity">
                    ...
                    <div id="single">
                        <div class="edit_sku">
                            ...
                            <input type="text" name="skuvalue" class="sku_value">
                        </div>
                        <div>
                            <span class="sku_name"></span>
                            <span class="sku_name_value"></span>
                        </div>
                        <div class="info">
                            <span>商品价格</span>
                            <input type="text" class="class-commodity commodity_value" placeholder="￥" name="price" id="price" />
                            <span>原价</span>
                            <input type="text" class="class-commodity commodity_value" placeholder="￥" name="old_price" id="old_price" />
                        </div>              
                    </div>
                    <!-- 多规格 -->
                ...
                <div class="edit-commodity">
                    ...
                    <div class="commodity-class-list buy_number">
                      ...
                      <div style="display:inline-block;width:50%;">
                          <input type="text" name="limit_count" value='0' class="class-commodity limitbuy">
        ...
        <div class="edit-commodity-detail">
          <div class="edit-commodity-detail-container">            
              <div class="commodity-introduce">
                  ...
                  <textarea type="text" class="introduce-msg" name="brief_introduction" id="brief_introduction" >微信分享给好友会显示这里的文章</textarea>
              </div>
               ...
               $("#show_form").ajaxSubmit({
                  ...
                  dataType:"json",
                    success: function(data) {
                      ...
                      img.push(data.path);
                      ordernum++;
                      var element = '<li class="'+ordernum+'"><img src='+img_src+' class="img-show" /></li>';
           ...
           $(".on-shelf").on("click",function(){
            ...
            $('#addsku').click(function(){
                ...
                var element = '<div class="box box-success">'+
                    '<div class="box-header with-border">'+
                        ...
                        '<div class="box-tools pull-right-input">'+
            ...
            $('#multiple').on('click','.addvalue',function(){
              ...
              if($(this).parent('.box-tools').prev().html()!=skuname){
                ...
                $(this).prev().val('');
                var element = '<label class="checkbox-inline checkbox-inline'+s+'" style="display:none;">'+
