...
@endsection
    ...
    <div class="container-commodity">
        <div class="commodity-edit">
            <span class="commodity-word">广告新增</span>
            <a href="/Brand/shuffling/"><button class="commodity-return allhover">返回</button></a>
        </div>
        <div class="new-window">
            <form action='/Brand/shuffling/add' method="post" enctype="multipart/form-data" id="form">
                 {!! csrf_field() !!}
                 <div class="add-success">{{Session::get('Message')}}</div>
                 @if (count($errors) > 0)
                ...
                <div class="add-content">
                    <span>广告名称：</span>
                    <input type="text" name="name" class="ad_name">
                </div>
                <div class="add-content">
                    <span>所属分店：</span>
                ...
                <div class="add-content">
                    ...
                    <div class="js_uploadBox1">
                        ...
                        <div class="js_showBox1" id="js_showBox1" style="height:200px;">
                        </div>        
                    </div> 
                ...
                <div class="add-content">
                    ...
                    <div class="httpsrc_div" hidden><input type="text" name="http_src" class="http_src"></div>
                    <div class="clearfix" style="clear:both;"></div>
                </div>                              
