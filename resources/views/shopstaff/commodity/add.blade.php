        ...
        <div class="choose-commodity">
             <div class="commodity-class">
              @foreach($category_lists as $list)
                <div class="commodity-list" category-id='{{$list->id}}'>{{$list->name}}</div>
                <input type="text" name="category_name" id="category_name" hidden>
                <input type="text" name="category_id" id="catetory_id" hidden>
              @endforeach
              </div> 
             <div class="next">
            ...
            <div class="msg-edit">
                ...
                <div class="edit-commodity">
                    <div class="commodity-class-list">
                       <p>商品名</p>
                       <input type="text" class="class-commodity" name="commodity_name" id="commodity_name" />
                    </div>
                   <div class="commodity-class-list">
                     <p>商品类型</p>
                     <label>
                        <input type="radio" name="type" value="1" checked/> 实物商品
                      </label>
                       <label>
                         <input type="radio" name="type" value="0" /> 虚拟商品
                       </label>
                   ...
                   <div class="commodity-class-list">
                     <p>是否推荐</p>
                      <label>
                        <input type="radio" name="is_recommend" value="1" checked/> 推荐商品
                      </label>
                       <label>
                         <input type="radio" name="is_recommend" value="0" /> 暂不推荐
                       </label>
                       
                   </div>
                   <div class="commodity-class-list">
                       <p>商品一级产地</p>
                       <input type="text" class="class-commodity" name="produce_area1" id="produce_area1" />
                    </div>
                    <div class="commodity-class-list">
                       <p>商品二级产地</p>
                       <input type="text" class="class-commodity" name="produce_area2" id="produce_area2" />
                    </div>
                </div>
                ...
                <div class="edit-commodity" style="min-height:600px">
                    <div class="commodity-class-list">
                     <p>规格选择</p>
                      <label>
                        <input type="radio" id="radio_single" name="sku_info" value="0" checked>
                        统一规格
                      </label>
                      <label>
                        <input type="radio" id="radio_multiple" name="sku_info"  value="1">
                        多规格
                      </label>
                    ...
                    <div id="single">
                        <div class="commodity-class-list">
                           <p>商品价格</p>
                           <input type="text" class="class-commodity" name="price" id="price" />
                        </div>
                        <div class="commodity-class-list">
                           <p>商品库存</p>
                           <input type="text" class="class-commodity" name="quantity" id="quantity" />
                        </div>                 
                    </div>
                    <div id="multiple" style="display: none;margin-top:30px">
                        <div class="form-group">
                            <label for="skuname">商品规格名称</label>
                            <input type="text"  id="skuname" placeholder="商品规格名称">
                            <input type="text" name="sku_length" hidden>
                   ...
                   <div class="commodity-class-img">
                     <p>商品主图</p>
                       <form  action='/Shopstaff/commodity/uploadimg' id="rendering_form" enctype="multipart/form-data">
                         ...
                         <input type="text" name="main_img" hidden>
                       </form>
                ...
                <div class="edit-commodity">
                    <div class="commodity-class-list">
                       <p>运费</p>
                       <label>
                         <input type="radio" name="use_express_template" value="0" checked /> 统一运费<input type="text" class="class-commodity" placeholder="￥：" name="express_price" />
                       </label>
                       <label>
                          <input type="radio" name="use_express_template" value="1" />运费模板
                   ...
                   <div class="commodity-class-list" style="margin-bottom:30px">
                      ...
                      <label>
                        ...
                        <input type="radio"  name="has_vip_discount" value="1" >
                        参与会员折扣
                      </label>
                      <label>
                      
                        <input type="radio"  name="has_vip_discount"  value="0" checked>
                        不参与会员折扣
                      </label>
      ...
      <div class="edit-commodity-detail">
          <div class="edit-commodity-detail-container">
              ...
              <div class="commodity-introduce">
                  ...
                  <textarea type="text" class="introduce-msg" name="brief_introduction" id="brief_introduction" ></textarea>
              </div>


               <div class="commodity-detail-edit">
                  <span class="introduce-title">编辑商品详情</span>
                  <textarea class="introduce-msg-detail"  id="description" name="description"></textarea>   
              </div>
