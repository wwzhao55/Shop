...
@section('content')
<div class="addBranch">
        <form action='/Admin/shopmanage/changeinfo' method="post" enctype="multipart/form-data"  onsubmit="return check()">
             {!! csrf_field() !!}
            <div class="page-head">{{$shopinfo->shopname}}<a href="javascript:history.go(-1)"><input value="返回" type="button" class="add-return"></a></div>
            <div>
                {{Session::get('Message')}}
            </div> 
            <div class="branch-left">
                <input type="text" name="shop_id" value="{{$shopinfo->id}}" hidden="">
                    <div class="branch-top {{ $errors->has('shopname') ? ' has-error' : '' }}">
                        <span>分店名 :</span>
                        <input type="text" name="shopname" value="{{$shopinfo->shopname}}">
                    ...
                    <div class="branch-list {{ $errors->has('customer_service_phone') ? ' has-error' : '' }}">
                        <span>客服电话 :</span>
                        <input type="text" placeholder="电话："   name="customer_service_phone" value="{{$shopinfo->customer_service_phone}}">
                    ...
                    <div class="branch-list {{ $errors->has('contacter_name') ? ' has-error' : '' }}">
                        <span>负责人 :</span>
                        <input type="text" placeholder="姓名："   name="contacter_name" value="{{$shopinfo->contacter_name}}">
                    ...
                    <div class="branch-list {{ $errors->has('contacter_phone') ? ' has-error' : '' }}">
                        <span>手机号 :</span>
                        <input type="text" placeholder="手机号："  name="contacter_phone" value="{{$shopinfo->contacter_phone}}">
                    ...
                    <div class="mention3">&nbsp手机号为商户分店负责人登录名</div>
                    <div class="branch-list{{ $errors->has('password') ? ' has-error' : '' }}">
                        <span>密码 :</span>
                        <input type="password" placeholder=""  name="password" value="{{$shopinfo->password}}">
                    ...
                    <div class="mention3">&nbsp密码为该商户分店负责人首次默认登录密码</div>
                    <div class="branch-list{{ $errors->has('contacter_email') ? ' has-error' : '' }}">
                        <span>邮箱 :</span>
                        <input type="email" placeholder="邮箱："   name="contacter_email" value="{{$shopinfo->contacter_email}}">
                    ...
                    <div class="branch-list{{ $errors->has('contacter_QQ') ? ' has-error' : '' }}">
                        <span>QQ :</span>
                        <input type="text" placeholder="QQ："   name="contacter_QQ" value="{{$shopinfo->contacter_QQ}}">
                    ...
                    <div class="branch-list">
                        <span>地址 :</span>
                        <select  class="distinct-1" name="shop_district"  value=""> </select>
                        <select  class="city-1" name="shop_city"  value="">  </select>
                        <select  class="province-1" name="shop_province"  value="">  </select>   
                    </div>
                    <div class="branch-list{{ $errors->has('shop_address_detail') ? ' has-error' : '' }}">
                            <input type="text" placeholder="详细地址"   name="shop_address_detail" value="{{$shopinfo->shop_address_detail}}">
                    ...
                    <div class="branch-list{{ $errors->has('latitude') ? ' has-error' : '' }}">
                        <span>纬度 :</span>
                            <input type="text" placeholder="纬度"   name="latitude" value="{{$shopinfo->latitude}}">
                    ...
                    <div class="branch-list{{ $errors->has('longitude') ? ' has-error' : '' }}">
                        <span>经度 :</span>
                            <input type="text" placeholder="经度"   name="longitude" value="{{$shopinfo->longitude}}">
    ...
    $('.brandmanage').addClass('onsidebar');
     $(function () {
            ...
            $(".province-1").val("{{$shopinfo->shop_province}}");
            ...
            //绑定
            $(".province-1").change();
            $(".city-1").val("{{$shopinfo->shop_city}}");
            $(".city-1").change();
            $(".distinct-1").val("{{$shopinfo->shop_district}}");
    });   
        function check(){
            ...
            $("input[name='shop_address_detail']").on("blur", function () {
                ...
                else if ($("input[name='shop_address_detailshop_address_detail']").parent(".branch-list").has(".shopwarning")) {
                    {
                        $("input[name='shop_address_detail']").parent(".branch-list").find(".shopwarning").remove();
                    }
