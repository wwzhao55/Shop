...
@endsection
@section('content')
    <link rel="stylesheet" href="{{URL::asset('admin/css/createTemplate.css')}}">
        ...
        <h1>
            ...
            <div class="templateSet" style="height:160px;">
                <div class="form-group childPartSize">
                    ...
                    <input type="text" class="form-control" id="template_name"></div>
                <div class="form-group childPartSize">
                    <label for="template_backgroundColor">背景色：</label>
                    <input type="text" class="form-control" id="template_backgroundColor"></div>
                <div class="form-group childPartSize">
                    <label for="template_font">字体：</label>
                    <input type="text" class="form-control" id="template_font"></div>

                <div class="form-group childPartSize" style="margin-top:25px;">
                    <label for="template_describe">模板描述：</label>
                    <input type="text" class="form-control" id="template_describe"></div>
                <div class="form-group childPartSize" style="margin-top:25px;">
                    <label for="template_price">&nbsp;价格 ：</label>
                    <input type="text" class="form-control" id="template_price"></div>
            </div>
                    ...
                    <div id="templateRendering_imgs" class="templateRendering_imgs">
                        <ul>
                            <li id="img1" class="li_style">
                                <img src="{{URL::asset('admin/img/app_img/icon-add.png')}}" alt="">
                ...
                <div class="templateBtns">
                    ...
                    <div id="btns_left"  class="btns_left">
                        <table>
                            ...
                            <tbody>
                                <!-- <form  method='post' id="icon_left_form" action='/Admin/App/theme/buttongroup' enctype="multipart/form-data">
                                    <input type="file" id="icon_left"  style="display:none;" name=""/>                                
                                </form> -->
                                <tr>
                                    <td class="btns_left_tbody_name">ADD</td>
                                    <td class="btns_left_tbody_ICON">
                                        <img  src="{{URL::asset('uploads/app/theme/buttongroup/add.png')}}" alt="">
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/bill.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/btn.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/confirm.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/delect.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/gathering.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/history.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/history_hover.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/icon.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/input_9.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/input_middle_9.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/lace.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/list.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/list_hover.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/login_btn.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/order.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/pay.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/pay_mode.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/pay_mode_bg.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/radio.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/radio_active.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/reduce.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/return.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/search.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/select.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/shopping.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/submit.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
                                ...
                                <tr>
                                    ...
                                    <td class="btns_left_tbody_ICON">
                                        <img src="{{URL::asset('uploads/app/theme/buttongroup/success.png')}}" alt=""></td>
                                    <td class="btns_left_tbody_operation">
                                        <!-- <img class="btns_left_tbody_operation_img1" src="{{URL::asset('admin/img/app_img/icon-cancel-gray.png')}}" alt="">
                                        &nbsp; -->
    ...
    var path_arr=[];
        ...
        // 点击确定按钮，取消选中的按钮，弹窗消失
                    ...
                    // _this_advUp_nextInput.on("change", function(){
                        ...
                        $("#rendering_form").ajaxSubmit({
                                ...
                                success: function(data) {
                                    ...
                                    _img_serialNum.attr("src","/"+data.path);
          ...
          // });
            $(".btns_left_tbody_operation_img1").on("click",function(){
                    _this_icon_del=$(this);
                    // _this_icon_del.addclass("currentIconDel");
                    is_icon_empty_del = _this_icon_del.attr("src");
                        // alert(is_icon_empty_del);
                    // if( _this.hasClass("btnStyle_del_li1") ){
                    //     img_adv_serialNum=1;
                    // }else if( _this.hasClass("btnStyle_del_li2") ){
                    //     img_adv_serialNum=2;
          ...
          // 按钮组上传操作开始
                ...
                $(".btns_left_tbody_operation_img2").on("click",function(){
                    ...
                    $("#icon_left").attr("name",name_icon);
                      // _img_iconLeft_serialNum
                      // _this_icon_up_current=_this_icon_up.parent("td").parent("tr").find("td").ep(1);
                      // _this_icon_up_current.addclass("currentIconUp");
                        // $(this).parent("td").parent("tr").children("td").ep(1).addclass("currentIconUp");
                        // $(this).parent("td").prev("td").addclass("currentIconUp");
                    $("#icon_left").click();
                });

                        $("#icon_left").on("change", function(){
                            alert("进入input改变");
                            // alert($("#icon_left").value());
                            ...
                            $("#icon_left_form").ajaxSubmit({
                                    ...
                                    success: function(data) {
                                        alert("上传成功");
                                        // alert(data.path);
                                        // _this_icon_up.parent("td").prev("td").find("img").remove();
                                        // _this_icon_up.parent("td").prev("td").append("<img src=\"\" />");

                                        _this_icon_up.parent("td").prev("td").find("img").attr("src","");
                                        // alert(_this_icon_up.parent("td").prev("td").find("img").attr("src"));
                                        _this_icon_up.parent("td").prev("td").find("img").attr("src","http://localhost:8000/"+data.path+ "?temp=" + Math.random());
                            // _this_icon_up.parent("td").prev("td").find("img").attr("src","http://shop.dataguiding.com/"+data.path);
